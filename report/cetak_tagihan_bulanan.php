<?php
    ...
    <img src="../images/logo.jpg" alt="">
        ...
        <br/>
        <hr/>';
        $tampil = mysqli_query($connection,"SELECT * FROM tagihan INNER JOIN kegiatan_awal ON tagihan.id_keg=kegiatan_awal.kode WHERE ao='$nama_ao' AND tagihan.tanggal='$tanggal'");
