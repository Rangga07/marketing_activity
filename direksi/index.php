...
<body>
  ...
  <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#"><span>DIREKSI</span>PAGE</a>
  ...
  <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
      ...
      <hr>
      <li><a href="?page=kegiatan_awal-direksi"><em class="fa fa-calendar">&nbsp;</em> Kegiatan Harian</a></li>
  ...
  <div id="page-wrapper">
    ...
    } else if (@$_GET['page'] && @$_GET['page'] == 'kegiatan_awal-direksi') {
      include "../views/kegiatan/kegiatan_awal-direksi.php";
