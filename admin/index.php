...
<body>
  ...
  <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#"><span>MONITORING</span>PAGE</a>
  ...
  <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
      ...
      <li class="parent "><a data-toggle="collapse" href="#sub-item-1">
          <em class="fa fa-balance-scale">&nbsp;</em> RBB Data <span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span>
        </a>
        <ul class="children collapse" id="sub-item-1">
          <li><a class="" href="?page=rbb_tabungan">
              <span class="fa fa-arrow-right">&nbsp;</span> RBB Tabungan
            </a></li>
          <li><a class="" href="?page=rbb_kredit">
              <span class="fa fa-arrow-right">&nbsp;</span> RBB Kredit
            </a></li>
        </ul>
      </li>
      <hr>
      <li><a href="?page=kegiatan_awal-admin"><em class="fa fa-calendar">&nbsp;</em> Kegiatan Harian AO</a></li>
      ...
      <li class="parent "><a data-toggle="collapse" href="#sub-item-3">
        ...
        <ul class="children collapse" id="sub-item-3">
          ...
          <li><a class="" href="../views/tabungan/persentase_bulanan_tabungan.php" target="_blank">
              <span class="fa fa-arrow-right">&nbsp;</span> Persentase Bulanan
            </a></li>
          <li><a class="" href="../views/tabungan/tabungan_rank.php" target="_blank">
              <span class="fa fa-arrow-right">&nbsp;</span> Rank Wilayah
            </a></li>
          <!--<li><a class="" href="../views/tabungan/persentase_tahunan_tabungan.php" target="_blank">
                  <span class="fa fa-arrow-right">&nbsp;</span> Persentase Tahunan
                </a></li>-->
        </ul>
      </li>
      ...
      <li class="parent "><a data-toggle="collapse" href="#sub-item-5">
          <em class="fa fa-id-card-o">&nbsp;</em>Persentase Kredit <span data-toggle="collapse" href="#sub-item-5" class="icon pull-right"><em class="fa fa-plus"></em></span>
        </a>
        <ul class="children collapse" id="sub-item-5">
          <li><a class="" href="../views/kredit/persentase_bulanan_kredit.php" target="_blank">
              <span class="fa fa-arrow-right">&nbsp;</span> Plafond Bulanan
            </a></li>
          <li><a class="" href="../views/kredit/persentase_tahunan_kredit.php" target="_blank">
              <span class="fa fa-arrow-right">&nbsp;</span> Plafond Tahunan
            </a></li>
          <li><a class="" href="../views/kredit/persentase_bulanan_bakidebet.php" target="_blank">
              <span class="fa fa-arrow-right">&nbsp;</span> Baki Debet
            </a></li>
        </ul>
      </li>
      <hr />
      <li class="parent "><a data-toggle="collapse" href="#sub-item-9">
          <em class="fa fa-cogs">&nbsp;</em> Pengaturan <span data-toggle="collapse" href="#sub-item-5" class="icon pull-right"><em class="fa fa-plus"></em></span>
        </a>
        <ul class="children collapse" id="sub-item-9">
          <li><a href="?page=users"><em class="fa fa-user">&nbsp;</em> Users</a></li>
          <li><a href="?page=akses"><em class="fa fa-clock-o">&nbsp;</em> Akses</a></li>
        </ul>
      </li>
      <!--<li><a href="?page=report_kegiatanlain"><em class="fa fa-spinner">&nbsp;</em> Kegiatan Lain</a></li><hr /> -->
  ...
  <div id="page-wrapper">
    ...
    } else if (@$_GET['page'] && @$_GET['page'] == 'kegiatan_awal-admin') {
      include "../views/kegiatan/kegiatan_awal-admin.php";
    ...
    } else if (@$_GET['page'] && @$_GET['page'] == 'akses') {
      include "../views/users/akses.php";
