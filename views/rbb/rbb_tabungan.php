...
?>
    ...
    <div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">RBB Tabungan</h1>
			</div>
            <div class="col-lg-12">
			</div>
						...
						<div class="tab-content">
							<div class="tab-pane fade in active" id="pilltab">
                                <div class="panel-body">
                                    <form role="form" action="../action/rbb_tabungan_action.php" method="post" enctype="multipart/form-data">
									...
									<br><br>
									<hr>
									<h4 align="center"><b> RBB TABUNGAN KESELURUHAN </b></h4>
									<br>
							...
							<div class="tab-pane fade" id="pilltab1">
                                <div class="panel-body">
                                    <form role="form" action="../action/rbb_tabungan_action.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="kode_all" id="tahun">
												...
												$sql = mysqli_query($dbconnect, "SELECT * FROM rbb_tabungan_all");
									...
									<br><br>
									<hr>
									<h4 align="center"><b> RBB TABUNGAN PERBULAN </b></h4>
									<br>
									<table class= "table table-bordered table-hover table-striped">
										<thead>
											<tr>
							...
							<div class="tab-pane fade" id="pilltab2">
                                <div class="panel-body">
                                    <form role="form" action="../action/rbb_tabungan_action.php" method="post" enctype="multipart/form-data">
										...
										<label>Tahun</label><br/>
                                            ...
                                            <select class="form-control" name="kode_bul" id="tahun">
												...
												$sql = mysqli_query($dbconnect, "SELECT rbb_tabungan_bul.kode,rbb_tabungan_bul.bulan,rbb_tabungan_all.periode FROM rbb_tabungan_bul JOIN rbb_tabungan_all ON rbb_tabungan_bul.kode_all=rbb_tabungan_all.kode");
												$nama_bulan = array('', 'Januari','Februari','Maret','April','Mei','Juni','Juli','Agustus','September','Oktober','November','Desember');
									...
									<br><br>
									<hr>
									<h4 align="center"><b> RBB TABUNGAN PER WILAYAH </b></h4>
									<br>
									<table class= "table table-bordered table-hover table-striped">
										<thead>
											<tr>
							...
							<div class="panel-body">
								<form role="form" action="../action/rbb_tabungan_action.php" method="post" enctype="multipart/form-data">
									<div class="form-group">
											...
											<select class="form-control" name="kode_bul" id="tahun">
												...
												while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
													echo "<option value='".$data['kode']."'>".$nama_bulan[$data['bulan']]."</option>";
												}
												?>
											</select>
								...
								<br><br>
								<hr>
								<h4 align="center"><b> RBB TABUNGAN PER AO </b></h4>
								<br>
								<table class= "table table-bordered table-hover table-striped">
									<thead>
										<tr>
									...
									<tbody>
										<tr>
											...
											<td><?php echo $nama_bulan[$data->bulan] ?></td>
											<td align="center"><a href="?page=rbb_tabungan&act=del&kode=<?php echo $data->kode; ?>" onclick="return confirm('Anda yakin akan menghapus data ini ?')">
	...
	header("location: ?page=rbb_tabungan");
}
