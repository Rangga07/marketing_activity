			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<?php
								...
								if (mysqli_num_rows($tampil) >= 0) {
									$result = mysqli_fetch_object($tampil);
									$sql2 = mysqli_query($dbconnect, "SELECT SUM(nominal) AS total FROM realisasi WHERE wilayah='Ciwidey 1' AND tgl='$ftanggal'");
									$sql3 = mysqli_query($dbconnect, "SELECT SUM(nominal) AS total FROM pelunasan WHERE wilayah='Ciwidey 1' AND tgl='$ftanggal'");
									$sql4 = mysqli_query($dbconnect, "SELECT SUM(nominal) AS total FROM realisasi WHERE tgl='$ftanggal'");
									$sql5 = mysqli_query($dbconnect, "SELECT SUM(nominal) AS total FROM realisasi WHERE tgl='$ftanggal_pem' AND wilayah='Ciwidey 1'");
									$sql6 = mysqli_query($dbconnect, "SELECT SUM(nominal) AS total FROM pelunasan WHERE tgl='$ftanggal_pem' AND wilayah='Ciwidey 1'");
									$total = mysqli_fetch_array($sql2);
									$total2 = mysqli_fetch_array($sql3);
									$total3 = mysqli_fetch_array($sql4);
									$total4 = mysqli_fetch_array($sql5);
						...
						<table class="table table-bordered table-hover table-striped table1" id="datatables">
							...
							<?php
								...
								while ($data = $tampil->fetch_object()) {
									...
									$ao = $data->username;
									$sql = mysqli_query($dbconnect, "SELECT SUM(noa) AS total FROM realisasi WHERE wilayah='Ciwidey 1' AND ao='$ao' AND tgl='$ftanggal'");
									$sql2 = mysqli_query($dbconnect, "SELECT SUM(nominal) AS total FROM realisasi WHERE wilayah='Ciwidey 1' AND ao='$ao' AND tgl='$ftanggal'");
									$sql3 = mysqli_query($dbconnect, "SELECT * FROM rbb_kredit_ao JOIN user ON rbb_kredit_ao.id_user=user.id 
                                                                        ...
                                                                        WHERE nama='$ao' AND bulan='$bulan' AND periode='$fperiode' AND wilayah='Ciwidey 1'");
									$sql4 = mysqli_query($dbconnect, "SELECT SUM(noa) AS total FROM pelunasan WHERE wilayah='Ciwidey 1' AND ao='$ao' AND tgl='$ftanggal'");
									$sql5 = mysqli_query($dbconnect, "SELECT SUM(nominal) AS total FROM pelunasan WHERE wilayah='Ciwidey 1' AND ao='$ao' AND tgl='$ftanggal'");
									$sql6 = mysqli_query($dbconnect, "SELECT * FROM rbb_kredit_ao JOIN user ON rbb_kredit_ao.id_user=user.id 
                                                                        JOIN rbb_kredit_bul ON rbb_kredit_ao.kode_bul=rbb_kredit_bul.kode
                                                                        JOIN rbb_kredit_all ON rbb_kredit_ao.kode_all=rbb_kredit_all.kode
																		WHERE nama='$ao' AND bulan='$bulan' AND periode='$fperiode' AND wilayah='Ciwidey 1'");
									$sql7 = mysqli_query($dbconnect, "SELECT SUM(nominal) AS total FROM realisasi WHERE wilayah='Ciwidey 1' AND ao='$ao' AND tgl='$ftanggal_pem'");
									$sql8 = mysqli_query($dbconnect, "SELECT SUM(nominal) AS total FROM realisasi WHERE wilayah='Ciwidey 1' AND tgl='$ftanggal'");
									$sql9 = mysqli_query($dbconnect, "SELECT SUM(noa) AS total FROM realisasi WHERE wilayah='Ciwidey 1' AND ao='$ao' AND tgl='$ftanggal_pem'");
									$sql10 = mysqli_query($dbconnect, "SELECT SUM(noa) AS total FROM pelunasan WHERE wilayah='Ciwidey 1' AND ao='$ao' AND tgl='$ftanggal_pem'");
									$sql11 = mysqli_query($dbconnect, "SELECT SUM(nominal) AS total FROM pelunasan WHERE wilayah='Ciwidey 1' AND ao='$ao' AND tgl='$ftanggal_pem'");
								...
								if (mysqli_num_rows($tampil) >= 0) {
									...
									echo "<table border='0' class='table1' height=90>
														<tr>
															...
															<td rowspan='4' width=230><div class='easypiechart' id='easypiechart' data-percent='$per_kredit'><b>Pertumbuhan kredit thdp target</b><span class='percent'><br>$per_kredit %</span></div></td>
															<td rowspan='4' width=230><div class='easypiechart' id='easypiechart' data-percent='$per_selisih_rea'><b>Pertumbuhan realisasi thdp pembanding </b><span class='percent'><br>$per_selisih_rea %</span> <br/><br/><br/><br/> Rp. " . number_format($selisih_realisasi) . "</div></td>
															<td rowspan='4' width=230><div class='easypiechart' id='easypiechart' data-percent='$per_selisih_pel'><b>Pertumbuhan pelunasan thdp pembandinga </b><span class='percent'><br>$per_selisih_pel %</span> <br/><br/><br/><br/> Rp. " . number_format($selisih_pelunasan) . "</div></td>
															<td rowspan='4' width=230><div class='easypiechart' id='easypiechart' data-percent='$per_realisasi'><b>Persentase realisasi thdp target</b><span class='percent'><br>$per_realisasi %</span></div></td>
															<td rowspan='4' width=230><div class='easypiechart' id='easypiechart' data-percent='$per_kontribusi'><b>Kontribusi Wilayah thdp keseluruhan</b><span class='percent'><br>$per_kontribusi %</span></div></td>
														</tr>
														<tr>	
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<?php
								...
								if (mysqli_num_rows($tampil) >= 0) {
									$result = mysqli_fetch_object($tampil);
									$sql2 = mysqli_query($dbconnect, "SELECT SUM(nominal) AS total FROM realisasi WHERE wilayah='Ciwidey 3' AND tgl='$ftanggal'");
									$sql3 = mysqli_query($dbconnect, "SELECT SUM(nominal) AS total FROM pelunasan WHERE wilayah='Ciwidey 3' AND tgl='$ftanggal'");
									$sql4 = mysqli_query($dbconnect, "SELECT SUM(nominal) AS total FROM realisasi WHERE tgl='$ftanggal'");
									$sql5 = mysqli_query($dbconnect, "SELECT SUM(nominal) AS total FROM realisasi WHERE tgl='$ftanggal_pem' AND wilayah='Ciwidey 3'");
									$sql6 = mysqli_query($dbconnect, "SELECT SUM(nominal) AS total FROM pelunasan WHERE tgl='$ftanggal_pem' AND wilayah='Ciwidey 3'");
									$total = mysqli_fetch_array($sql2);
									$total2 = mysqli_fetch_array($sql3);
									$total3 = mysqli_fetch_array($sql4);
									$total4 = mysqli_fetch_array($sql5);
						...
						<table class="table table-bordered table-hover table-striped table1" id="datatables">
							...
							<?php
								...
								while ($data = $tampil->fetch_object()) {
									...
									$bulan = date("n", strtotime($periode));
									$ao = $data->username;
									$sql = mysqli_query($dbconnect, "SELECT SUM(noa) AS total FROM realisasi WHERE wilayah='Ciwidey 3' AND ao='$ao' AND tgl='$ftanggal'");
									$sql2 = mysqli_query($dbconnect, "SELECT SUM(nominal) AS total FROM realisasi WHERE wilayah='Ciwidey 3' AND ao='$ao' AND tgl='$ftanggal'");
									$sql3 = mysqli_query($dbconnect, "SELECT * FROM rbb_kredit_ao JOIN user ON rbb_kredit_ao.id_user=user.id 
                                                                        JOIN rbb_kredit_bul ON rbb_kredit_ao.kode_bul=rbb_kredit_bul.kode
                                                                        JOIN rbb_kredit_all ON rbb_kredit_ao.kode_all=rbb_kredit_all.kode
                                                                        WHERE nama='$ao' AND bulan='$bulan' AND periode='$fperiode' AND wilayah='Ciwidey 3'");
									$sql4 = mysqli_query($dbconnect, "SELECT SUM(noa) AS total FROM pelunasan WHERE wilayah='Ciwidey 3' AND ao='$ao' AND tgl='$ftanggal'");
									$sql5 = mysqli_query($dbconnect, "SELECT SUM(nominal) AS total FROM pelunasan WHERE wilayah='Ciwidey 3' AND ao='$ao' AND tgl='$ftanggal'");
									$sql6 = mysqli_query($dbconnect, "SELECT * FROM rbb_kredit_ao JOIN user ON rbb_kredit_ao.id_user=user.id 
                                                                        JOIN rbb_kredit_bul ON rbb_kredit_ao.kode_bul=rbb_kredit_bul.kode
                                                                        JOIN rbb_kredit_all ON rbb_kredit_ao.kode_all=rbb_kredit_all.kode
																		WHERE nama='$ao' AND bulan='$bulan' AND periode='$fperiode' AND wilayah='Ciwidey 3'");
									$sql7 = mysqli_query($dbconnect, "SELECT SUM(nominal) AS total FROM realisasi WHERE wilayah='Ciwidey 3' AND ao='$ao' AND tgl='$ftanggal_pem'");
									$sql8 = mysqli_query($dbconnect, "SELECT SUM(nominal) AS total FROM realisasi WHERE wilayah='Ciwidey 3' AND tgl='$ftanggal'");
									$sql9 = mysqli_query($dbconnect, "SELECT SUM(noa) AS total FROM realisasi WHERE wilayah='Ciwidey 3' AND ao='$ao' AND tgl='$ftanggal_pem'");
									$sql10 = mysqli_query($dbconnect, "SELECT SUM(noa) AS total FROM pelunasan WHERE wilayah='Ciwidey 3' AND ao='$ao' AND tgl='$ftanggal_pem'");
									$sql11 = mysqli_query($dbconnect, "SELECT SUM(nominal) AS total FROM pelunasan WHERE wilayah='Ciwidey 3' AND ao='$ao' AND tgl='$ftanggal_pem'");
