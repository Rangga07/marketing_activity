				...
				<div class="panel panel-danger">
					...
					<div class="panel-body">
                        ...
                        <?php 
							...
							echo "<a href='../report/cetak_promosi.php?id_keg=$result->id_keg' target='_blank'><button class='btn btn-default btn-md' style='float:right'><i class='fa fa-print'></i> Cetak</button></a>";
						...
						?>
							<table class= "table table-bordered table-hover table-striped" id="datatables">
								...
								<tr>
									...
									<td><?php echo $data->alamat ?></td></td>
									<td><?php echo $data->no_hp ?></td></td>
									<td><?php echo $data->kep ?></td></td>
