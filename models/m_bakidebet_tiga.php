...
class BDT {
	...
	public function tampil_bakidebet_ciwideytiga($kode = null) {
		$db = $this->mysqli->conn;
		$periode = $_POST['periode'];
		$ftanggal = date("Y/m/d", strtotime($periode));
		$sql = "SELECT SUM(bk_lancar) as total_lancar, SUM(bk_dpk) as total_dpk, SUM(bk_kl) as total_kl, SUM(bk_dir) as total_dir, SUM(bk_m) as total_m,
                        SUM(noa_lancar) as noa_lancar, SUM(noa_dpk) as noa_dpk, SUM(noa_kl) as noa_kl, SUM(noa_dir) as noa_dir, SUM(noa_m) as noa_m
                FROM bakidebet WHERE tgl='$ftanggal' AND wilayah='Ciwidey 3'";
		if($kode != null) {
			$sql .= "WHERE kode = $kode";
		}
		$query = $db->query($sql) or die ($db->error); 
    ...
    public function tampil_bakidebet_ciwideytiga_seb($kode = null) {
		$db = $this->mysqli->conn;
		$pembanding = $_POST['pembanding'];
		$ftanggal_pem = date("Y/m/d", strtotime($pembanding));
		$sql = "SELECT SUM(bk_lancar) as total_lancar, SUM(bk_dpk) as total_dpk, SUM(bk_kl) as total_kl, SUM(bk_dir) as total_dir, SUM(bk_m) as total_m,
                        SUM(noa_lancar) as noa_lancar, SUM(noa_dpk) as noa_dpk, SUM(noa_kl) as noa_kl, SUM(noa_dir) as noa_dir, SUM(noa_m) as noa_m
                FROM bakidebet WHERE tgl='$ftanggal_pem' AND wilayah='Ciwidey 3'";
		if($kode != null) {
			$sql .= "WHERE kode = $kode";
		}
		$query = $db->query($sql) or die ($db->error); 
    ...
    //bk lancar Ciwidey 3
	public function tampil_bakidebetlancar_ciwideytiga($ao) {
		$db = $this->mysqli->conn;
		$periode = $_POST['periode'];
		$ftanggal = date("Y/m/d", strtotime($periode));
    ...
    public function tampil_bakidebetlancar_ciwideytiga_seb($ao) {
		$db = $this->mysqli->conn;
		$pembanding = $_POST['pembanding'];
		$ftanggal_pem = date("Y/m/d", strtotime($pembanding));
    ...
    //bk dpk ciwidey dua
	public function tampil_bakidebetdpk_ciwideytiga($ao) {
		$db = $this->mysqli->conn;
		$periode = $_POST['periode'];
		$ftanggal = date("Y/m/d", strtotime($periode));
    ...
    public function tampil_bakidebetdpk_ciwideytiga_seb($ao) {
		$db = $this->mysqli->conn;
		$pembanding = $_POST['pembanding'];
		$ftanggal_pem = date("Y/m/d", strtotime($pembanding));
	...
	//bk kl ciwidey dua
	public function tampil_bakidebetkl_ciwideytiga($ao) {
		$db = $this->mysqli->conn;
		$periode = $_POST['periode'];
		$ftanggal = date("Y/m/d", strtotime($periode));
    ...
    public function tampil_bakidebetkl_ciwideytiga_seb($ao) {
		$db = $this->mysqli->conn;
		$pembanding = $_POST['pembanding'];
		$ftanggal_pem = date("Y/m/d", strtotime($pembanding));
    ...
    //bk kl ciwidey dua
	public function tampil_bakidebetdir_ciwideytiga($ao) {
		$db = $this->mysqli->conn;
		$periode = $_POST['periode'];
		$ftanggal = date("Y/m/d", strtotime($periode));
    ...
    public function tampil_bakidebetdir_ciwideytiga_seb($ao) {
		$db = $this->mysqli->conn;
		$pembanding = $_POST['pembanding'];
		$ftanggal_pem = date("Y/m/d", strtotime($pembanding));
    ...
    //bk kl ciwidey dua
	public function tampil_bakidebetm_ciwideytiga($ao) {
		$db = $this->mysqli->conn;
		$periode = $_POST['periode'];
		$ftanggal = date("Y/m/d", strtotime($periode));
    ...
    public function tampil_bakidebetm_ciwideytiga_seb($ao) {
		$db = $this->mysqli->conn;
		$pembanding = $_POST['pembanding'];
		$ftanggal_pem = date("Y/m/d", strtotime($pembanding));
